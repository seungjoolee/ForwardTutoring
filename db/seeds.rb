...
math  = Subject.create(:title => "Math")
  geometry = math.fields.create(:title => "Geometry")
    proofs = geometry.topics.create(:title => "Proofs")
      ...
      area_proof = proofs.resources.create(:title => "Proof: Area of a Circle", :posted_by => "Calvin Woo", :description => "Detailed proof and description of A=piR^2.", :link => "www.facebook.com")
    parallel_and_perpendicular_lines = geometry.topics.create(:title => "Parallel and Perpendicular Lines")
      intersections = parallel_and_perpendicular_lines.resources.create(:title => "Wow! Intersecting Lines!", :posted_by => "Calvin Woo", :description => "10 short answer questions. High difficulty.", :link => "www.facebook.com")
    triangles = geometry.topics.create(:title => "Triangles")
      triangle_types = triangles.resources.create(:title => "Triangle Types Worksheet", :posted_by => "Calvin Woo", :description => "25 multiple choice questions. Circle the correct triangle type.", :link => "www.facebook.com")
