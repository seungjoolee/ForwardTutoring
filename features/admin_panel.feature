...
Scenario: Add a new subject
  When I click "Subjects" in the navbar
  And I click "New Subject"
  And I fill in "Title" with "Social Studies"
  And I click "Create Subject"
  Then I should see in "flash_notice", "Subject was successfully created"

Scenario: Edit an existing subject
  When I click "Subjects" in the navbar
  And I click "Edit" in the table next to "Math"
  And I fill in "Title" with "Social Studies"
  And I click "Update Subject"
  Then I should see in "flash_notice", "Subject was successfully updated"

Scenario: Add a new field
  When I click "Fields" in the navbar
  ...
  Then I should see in "flash_notice", "Field was successfully created"

Scenario: Edit an existing field
  When I click "Fields" in the navbar
  And I click "Edit" in the table next to "Geometry"
  And I fill in "Title" with "Algebra II"
  And I click "Update Field"
  Then I should see in "flash_notice", "Field was successfully updated"

Scenario: Add a new topic
  When I click "Topics" in the navbar
  ...
  Then I should see in "flash_notice", "Topic was successfully created"

Scenario: Edit an existing topic
  When I click "Topics" in the navbar
  And I click "Edit" in the table next to "Proofs"
  ...
  Then I should see in "flash_notice", "Topic was successfully updated"